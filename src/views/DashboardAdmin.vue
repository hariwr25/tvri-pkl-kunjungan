  ...
  <div class="min-h-screen bg-gray-900 text-gray-100 p-8 font-sans">
    ...
    >
      ...
      <div class="flex items-center space-x-6">
        <!-- Jam Digital -->
        <div
          class="font-mono text-xl font-medium px-6 py-2 bg-gray-800 rounded-lg shadow-inner border border-gray-700"
...
export default {
  ...
  methods: {
    ...
    renderChartPkl() {
      if (this.chartPkl) this.chartPkl.destroy()
      const ctx = document.getElementById('chartPkl').getContext('2d')
    ...
    renderChartKunjungan() {
      ...
      this.chartKunjungan = new Chart(ctx, {
        ...
        options: {
          responsive: true,
          plugins: {
            legend: { display: true, labels: { color: '#D1D5DB' } }, // gray-300
            tooltip: { enabled: true },
          },
          scales: {
            y: {
              beginAtZero: true,
              grid: { color: '#1E40AF' }, // blue-900
